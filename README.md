...
出典台帳は230件。今回124件を追加し、出典未登録は131テーマから29テーマになりました。登録だけで科学的結論を確認したことにはなりません。
...
出典未登録29テーマを引き続き直接資料で補います。登録済みでも書誌・背景だけの場合があり、全文・独立追試・反証・訂正・日本への適用を確認してから記事化します。全テーマのpublication_readyはfalseです。
